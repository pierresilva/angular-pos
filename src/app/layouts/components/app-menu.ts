    ...
    $.app = {
      menu: {
        ...
        manualScroller: {
          ...
          init: function () {
            let scroll_theme = ($('.main-menu').hasClass('menu-dark')) ? 'light' : 'dark';
          ...
          update: function () {
            if (this.obj) {
              ...
              if ($('.main-menu').data('scroll-to-active') === true) {
                ...
                if (activeEl > (menu.clientHeight * 2) / 3) {
                  start = menu.scrollTop;
                  change = activeEl - start - (menu.clientHeight / 2);
                }
                setTimeout(function () {
        ...
        change: function (defMenu) {
          let currentBreakpoint = Unison.fetch.now(); // Current Breakpoint
            ...
            $(input)
              .change(function () {
                ...
                if (filter) {
                  ...
                  let searchFilter = $(list).find("li a:Contains(" + filter + ")");
        ...
        changeMenu: function (screen) {
          ...
          let menuWrapper = $('div[data-menu="menu-wrapper"]'),
