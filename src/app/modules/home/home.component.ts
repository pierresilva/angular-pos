...
export class HomeComponent implements OnInit {
  ...
  init() {
    ...
    let sessionChart = new ApexCharts(
    ...
    let supportChart = new ApexCharts(
          ...
          dataLabels: {
            ...
            total: {
              ...
              formatter(w) {
                ...
                // to show the use of custom formatter function
                return 42459;
              }
            }
          }
    ...
    let productChart = new ApexCharts(
